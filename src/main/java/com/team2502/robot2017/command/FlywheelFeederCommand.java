...
public class FlywheelFeederCommand extends Command
{
     ...
     */
    public FlywheelFeederCommand(long runTime)
    {
     ...
     */
    public FlywheelFeederCommand(double runTime)
    {
