    ...
    public static void main(String[] args) throws Exception
    {
        ...
        while((line = br.readLine()) != null)
        {
            if(line.startsWith("version="))
            {
                ...
                if(split.length < 2) { throw new Exception("Invalid file data."); }
                String[] digits = split[1].split("\\.");
                if(digits.length != 3) { throw new Exception("Invalid file data."); }
        ...
        switch(Integer.valueOf(args[1]))
        {
            ...
            case 2:
                ...
                break;
            default:
                throw new IllegalArgumentException("Version type must be `0` for build, `1` for minor and `2` for build.");
        }
